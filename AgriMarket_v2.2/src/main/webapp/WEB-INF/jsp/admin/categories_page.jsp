...
<html lang="ar_EG">
    <head>
        <title><spring:message code="title.admin.show.categories" /></title>
    ...
    <body>
        ...
        <c:if test="${empty categories}" >
            <c:redirect url="/admin/categories_page.htm" />
        </c:if>
                    ...
                    <div class="content_top" dir="<spring:message code="offer_page.css.content_top.dir" />">
                        ...
                        <div class="heading" style="float: <spring:message code="offer_page.css.heading.float" />;">
                            ...
                            <div class="heading" style="float: <spring:message code="index.css.heading.float" />;">
                                <h3><spring:message code="header.all.categories" /></h3>
                            </div>
                        </div>
                        ...
                        <div >
                            ...
                            <div class="add-cart">								
                                <h4><a href="<spring:url value="/admin/addcategory.htm"/>"><spring:message code="button.add.category" /></a></h4>
                            </div>
                            <div class="clear"></div>
                        </div>
                        <%-- end list--%>
                        ...
                        <c:forEach items="${categories}" var="category">
                            <div class="grid_1_of_4 images_1_of_4" style="margin-left: <spring:message code="offer-page.css.padding.product.margin-left" />;float: <spring:message code="offer_page.css.heading.float" />;">
                                ...
                                <div class="price-details">
                                    ...
                                    <div class="add-cart">								
                                        <h4><a href="preview_category.htm?id=${category.id}"><spring:message code="link.More.details" /></a></h4>
                                    </div>
                                    <div class="clear"></div>
                                </div>
                            </div>
