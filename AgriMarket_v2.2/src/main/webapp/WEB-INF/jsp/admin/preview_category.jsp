    ...
    <div class="wrap">
        <div class="header">
            ...
            <c:if test="${empty category}" >
                <c:redirect url="/admin/preview_category.htm?id=${param['id']}" />
            </c:if>
        </div>
        <!--profile-->
            ...
            <div class="row">
                    ...
                    <ul class="list-group">
                        <li style="text-align: <spring:message code="view-user.rate.text-align"/>;
                            ...
                            <span style="    margin-left: <spring:message code="view-user.rate.span.margin-left"/>px;" class="pull-left">
                                <strong class=""><spring:message code="text.name.en" /></strong></span>${category.nameEn}</li>
                        <li style="    text-align: <spring:message code="view-user.rate.text-align"/>;" class="list-group-item text-right">
                            <span style="margin-left: <spring:message code="view-user.rate.margin-left"/>px; direction: <spring:message code="view_user.css.rate.panel.dir"/>;" class="pull-left"><strong class=""><spring:message code="text.name.ar" /></strong></span> ${category.nameAr}</li>

                        <li style="    text-align: <spring:message code="view-user.rate.text-align"/>;" class="list-group-item text-right">
                            <span style="margin-left: <spring:message code="view-user.rate.margin-left"/>px; direction: <spring:message code="view_user.css.rate.panel.dir"/>;" class="pull-left"><strong class=""><spring:message code="text.parent.en" /></strong></span> ${category.category.nameEn}</li>
                        
                        <li style="    text-align: <spring:message code="view-user.rate.text-align"/>;" class="list-group-item text-right">
                            <span style="margin-left: <spring:message code="view-user.rate.margin-left"/>px; direction: <spring:message code="view_user.css.rate.panel.dir"/>;" class="pull-left"><strong class=""><spring:message code="text.parent.ar" /></strong></span> ${category.category.nameAr}</li>
                    </ul>
                ...
                <div class="col-sm-9" contenteditable="false" style="margin-top: -109px;">
                    ...
                    <div class="panel panel-default target" style="background: antiquewhite;">
                        ...
                        <div style="direction: <spring:message code="view_user.css.user-products.dir" />" class="panel-heading" contenteditable="false"><spring:message code="text.children" /></div>

                        <div class="panel-body" style="max-height: 345px;
                             border: 1px solid gray;
                             overflow: auto;">
                            <c:forEach items="${category.categories}" var="cat">
                                <div class="grid_1_of_4 images_1_of_4" style="margin-left: <spring:message code="offer-page.css.padding.product.margin-left" />;float: <spring:message code="offer_page.css.heading.float" />;">
                                    <a href="${pageContext.request.contextPath}/admin/preview_category.htm?id=${cat.id}">
                                        <img  
                                        style="border: 1.1px solid #2969b0;
                                        border-bottom: none; width: 220px; height: 150px;"  src="${pageContext.request.contextPath}${cat.imageUrl}" /></a>
                                            <h2>${requestScope.lang eq 'en'?cat.nameEn:cat.nameAr} </h2>
                                    <div class="price-details">
                                        
                                        <div class="add-cart">								
                                            <h4><a href="${pageContext.request.contextPath}/admin/preview_category.htm?id=${cat.id}"><spring:message code="link.More.details" /></a></h4>
                                        </div>
                                        <div class="clear"></div>
                                    </div>
                                </div>
