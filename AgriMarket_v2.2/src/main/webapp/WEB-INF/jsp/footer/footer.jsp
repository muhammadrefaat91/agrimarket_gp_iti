    ...
    <div class="wrap">	
        <div class="section group">
            <div class="col_1_of_4 span_1_of_4">
                ...
                <ul>
						<li><a href="about.htm"><spring:message code="link.footer.aboutus" /></a></li>
						<li><a href="contact.htm"><spring:message code="link.footer.contactus" /></a></li>
                </ul>
            </div>
            <div class="col_1_of_4 span_1_of_4">
                ...
                <ul>
						...
						<li><a href="contact.html"><spring:message code="link.footer.sitemap" /></a></li>
						</ul>
            ...
            <div class="col_1_of_4 span_1_of_4">
                ...
                <ul>
							<li><a href="login.html"><spring:message code="link.footer.signin" /></a></li>
<!--							<li><a href="#">Track My Order</a></li>-->
							<li><a href="contact.htm"><spring:message code="link.footer.help" /></a></li>
                </ul>
            </div>
            <div class="col_1_of_4 span_1_of_4">
