                ...
                <div class="col-sm-3" style="float: <spring:message code="view_user.css.row.col-sm-3.float" />;">
                    ...
                    <ul class="list-group">
                        ...
                        <li style="    text-align: <spring:message code="view-user.rate.text-align"/>;" class="list-group-item text-right"><span style="margin-left: <spring:message code="view-user.rate.margin-left"/>px;
                                                                                                                                                 direction: <spring:message code="view_user.css.rate.panel.dir"/>;" class="pull-left"><strong class=""><spring:message code="text.user.email" /></strong></span> <p>${userHasOffer.mail}</p></li>
                    ...
                    <div class="col-sm-9" contenteditable="false" style="">
                        ...
                        <div class="panel panel-default target" style="background: white;">
                            ...
                            <c:if test="${ empty sessionScope.user}">
                                <div class="alert alert-info alert-dismissable" style="    width: 79%;
;background-color: whitesmoke">
                            <a class="panel-close close" data-dismiss="alert">×</a> 
                            <i class="fa fa-coffee"></i>
                                                             <a href="${pageContext.request.contextPath}/web/signup.htm">Login to rate this user </a>
