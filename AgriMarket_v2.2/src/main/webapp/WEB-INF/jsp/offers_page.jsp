...
//
//         document.getElementById( "product" ).href = "${pageContext.request.contextPath}/web/getoffers.htm?lang="" + lang;
            ...
            onload = function ()
            {
//                window.location.replace("getoffers.htm?name=");
        ...
        <script type="text/javascript">
            ...
            var lang = $.cookie("myAppLocaleCookie");
            console.log("myAppLocaleCookie :" + lang);
